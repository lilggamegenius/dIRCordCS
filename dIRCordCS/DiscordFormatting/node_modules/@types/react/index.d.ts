...
declare namespace React {
    ...
    type ElementRef<C extends | ForwardRefExoticComponent<any>
        ...
        | keyof JSX.IntrinsicElements> = C extends ForwardRefExoticComponent<infer FP>
    ...
    interface ReactComponentElement<T extends keyof JSX.IntrinsicElements | JSXElementConstructor<any>,
        P = Pick<ComponentProps<T>, Exclude<keyof ComponentProps<T>, 'key' | 'ref'>>> extends ReactElement<P, Exclude<T, number>> {
    }
